...
export type AllCertifyVexStatementTreeFragment = { __typename?: 'CertifyVEXStatement', id: string, justification: string, knownSince: any, origin: string, collector: string, subject: { __typename: 'Artifact', id: string, algorithm: string, digest: string } | { __typename: 'Package', id: string, type: string, namespaces: Array<{ __typename?: 'PackageNamespace', id: string, namespace: string, names: Array<{ __typename?: 'PackageName', id: string, name: string, versions: Array<{ __typename?: 'PackageVersion', id: string, version: string, subpath: string, qualifiers: Array<{ __typename?: 'PackageQualifier', key: string, value: string }> }> }> }> }, vulnerability: { __typename: 'CVE', id: string, year: number, cveId: string } | { __typename: 'GHSA', id: string, ghsaId: string } | { __typename: 'OSV', id: string, osvId: string } } & { ' $fragmentName'?: 'AllCertifyVexStatementTreeFragment' };
...
export type AllCertifyVulnTreeFragment = { __typename?: 'CertifyVuln', id: string, package: { __typename?: 'Package', id: string, type: string, namespaces: Array<{ __typename?: 'PackageNamespace', id: string, namespace: string, names: Array<{ __typename?: 'PackageName', id: string, name: string, versions: Array<{ __typename?: 'PackageVersion', id: string, version: string, subpath: string, qualifiers: Array<{ __typename?: 'PackageQualifier', key: string, value: string }> }> }> }> }, vulnerability: { __typename: 'CVE', id: string, year: number, cveId: string } | { __typename: 'GHSA', id: string, ghsaId: string } | { __typename: 'OSV', id: string, osvId: string }, metadata: { __typename?: 'VulnerabilityMetaData', dbUri: string, dbVersion: string, scannerUri: string, scannerVersion: string, timeScanned: any, origin: string, collector: string } } & { ' $fragmentName'?: 'AllCertifyVulnTreeFragment' };
