...
export type AllHasSbomTreeFragment = { __typename?: 'HasSBOM', id: string, uri: string, algorithm: string, digest: string, downloadLocation: string, origin: string, collector: string, subject: { __typename: 'Artifact', id: string, algorithm: string, digest: string } | { __typename: 'Package', id: string, type: string, namespaces: Array<{ __typename?: 'PackageNamespace', id: string, namespace: string, names: Array<{ __typename?: 'PackageName', id: string, name: string, versions: Array<{ __typename?: 'PackageVersion', id: string, version: string, subpath: string, qualifiers: Array<{ __typename?: 'PackageQualifier', key: string, value: string }> }> }> }> } } & { ' $fragmentName'?: 'AllHasSbomTreeFragment' };
...
export type IsDependencyQ1QueryVariables = Exact<{ [key: string]: never; }>;


export type IsDependencyQ1Query = { __typename?: 'Query', IsDependency: Array<(
    { __typename?: 'IsDependency' }
    & { ' $fragmentRefs'?: { 'AllIsDependencyTreeFragment': AllIsDependencyTreeFragment } }
  )> };

export type IsDependencyQ2QueryVariables = Exact<{ [key: string]: never; }>;


export type IsDependencyQ2Query = { __typename?: 'Query', IsDependency: Array<(
    { __typename?: 'IsDependency' }
    & { ' $fragmentRefs'?: { 'AllIsDependencyTreeFragment': AllIsDependencyTreeFragment } }
  )> };

export type IsDependencyQ3QueryVariables = Exact<{ [key: string]: never; }>;


export type IsDependencyQ3Query = { __typename?: 'Query', IsDependency: Array<(
    { __typename?: 'IsDependency' }
    & { ' $fragmentRefs'?: { 'AllIsDependencyTreeFragment': AllIsDependencyTreeFragment } }
  )> };

export type IsDependencyQ4QueryVariables = Exact<{ [key: string]: never; }>;


export type IsDependencyQ4Query = { __typename?: 'Query', IsDependency: Array<(
    { __typename?: 'IsDependency' }
    & { ' $fragmentRefs'?: { 'AllIsDependencyTreeFragment': AllIsDependencyTreeFragment } }
  )> };

export type IsDependencyQ5QueryVariables = Exact<{ [key: string]: never; }>;


export type IsDependencyQ5Query = { __typename?: 'Query', IsDependency: Array<(
    { __typename?: 'IsDependency' }
    & { ' $fragmentRefs'?: { 'AllIsDependencyTreeFragment': AllIsDependencyTreeFragment } }
  )> };

export type IsDependencyQ6QueryVariables = Exact<{ [key: string]: never; }>;


export type IsDependencyQ6Query = { __typename?: 'Query', IsDependency: Array<(
    { __typename?: 'IsDependency' }
    & { ' $fragmentRefs'?: { 'AllIsDependencyTreeFragment': AllIsDependencyTreeFragment } }
  )> };
...
export type GetIsDependencyQueryVariables = Exact<{
  spec: IsDependencySpec;
}>;


export type GetIsDependencyQuery = { __typename?: 'Query', IsDependency: Array<(
    { __typename?: 'IsDependency' }
    & { ' $fragmentRefs'?: { 'AllIsDependencyTreeFragment': AllIsDependencyTreeFragment } }
  )> };

export type GetIsOccurrenceQueryVariables = Exact<{
  spec: IsOccurrenceSpec;
}>;
