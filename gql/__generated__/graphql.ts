 ...
 */
export type Node = Artifact | Builder | Cve | CertifyBad | CertifyPkg | CertifyScorecard | CertifyVexStatement | CertifyVuln | Ghsa | HasSbom | HasSlsa | HasSourceAt | HashEqual | IsDependency | IsOccurrence | IsVulnerability | Osv | Package | Source;
...
export type AllCertifyPkgTreeFragment = { __typename?: 'CertifyPkg', id: string, justification: string, origin: string, collector: string, packages: Array<{ __typename?: 'Package', id: string, type: string, namespaces: Array<{ __typename?: 'PackageNamespace', id: string, namespace: string, names: Array<{ __typename?: 'PackageName', id: string, name: string, versions: Array<{ __typename?: 'PackageVersion', id: string, version: string, subpath: string, qualifiers: Array<{ __typename?: 'PackageQualifier', key: string, value: string }> }> }> }> }> } & { ' $fragmentName'?: 'AllCertifyPkgTreeFragment' };
...
export type AllSlsaTreeFragment = { __typename?: 'HasSLSA', id: string, subject: { __typename?: 'Artifact', id: string, algorithm: string, digest: string }, slsa?: { __typename?: 'SLSA', buildType: string, slsaVersion: string, startedOn: any, finishedOn: any, origin: string, collector: string, builtFrom: Array<{ __typename?: 'Artifact', id: string, algorithm: string, digest: string }>, builtBy: { __typename?: 'Builder', id: string, uri: string }, slsaPredicate: Array<{ __typename?: 'SLSAPredicate', key: string, value: string }> } | null } & { ' $fragmentName'?: 'AllSlsaTreeFragment' };
...
export type GetNeighborsQuery = { __typename?: 'Query', neighbors: Array<{ __typename: 'Artifact' } | { __typename: 'Builder' } | { __typename: 'CVE' } | { __typename: 'CertifyBad' } | { __typename: 'CertifyPkg' } | { __typename: 'CertifyScorecard' } | { __typename: 'CertifyVEXStatement' } | { __typename: 'CertifyVuln' } | { __typename: 'GHSA' } | { __typename: 'HasSBOM' } | { __typename: 'HasSLSA' } | { __typename: 'HasSourceAt' } | { __typename: 'HashEqual' } | { __typename: 'IsDependency' } | { __typename: 'IsOccurrence' } | { __typename: 'IsVulnerability' } | { __typename: 'OSV' } | (
    { __typename: 'Package' }
    & { ' $fragmentRefs'?: { 'AllPkgTreeFragment': AllPkgTreeFragment } }
  ) | { __typename: 'Source' }> };
